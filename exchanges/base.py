...
class BaseExchange(object):
    ...
    def get_json_request(self, url):
        ...
        if url.startswith("https://www.coinw.com"):
            headers['Cookie'] = '__jsluid=af45b7896f4598cac1188c9a7383ddfd; zh_choose=n; Hm_lvt_525b7a4b6599566fc46ec53565d28557=1513301623,1513306316,1513503747; JSESSIONID=CAA5925F5C9010E0345A1C47D84E4AAC; username=11; __jsl_clearance=1515243847.949|0|Jr08v7DThv%2BLu%2FcCvUwJ8HYa55o%3D; Hm_lpvt_525b7a4b6599566fc46ec53565d28557=1515244500'
