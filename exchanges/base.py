...
class BaseExchange(object):
    ...
    def get_json_request(self, url):
        ...
        if url.startswith("https://api.etherdelta.com"):
            headers['cookie'] = '__cfduid=d7f445f60fd2d7312c90458ffd3503dfe1512358712; _ga=GA1.2.583018572.1512359163; _TRAEFIK_BACKEND=http://10.0.0.6:8001' 

        if url.startswith("https://www.coinw.com"):
            headers['Cookie'] = '__jsluid=035ec051aa976bb636e518ed43769b23; zh_choose=n; username=11; Hm_lvt_525b7a4b6599566fc46ec53565d28557=1513301623,1513306316,1513503747; Hm_lpvt_525b7a4b6599566fc46ec53565d28557=1515247664; __jsl_clearance=1515257060.794|0|hESOHPo%2FT7x9HAP9iEAQccB%2BX70%3D; JSESSIONID=11577E4702ECCE544E9ABFAE09369A7C'
